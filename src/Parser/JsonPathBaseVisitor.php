...
/**
 * This class provides an empty implementation of {@see JsonPathVisitor},
 * which can be extended to create a visitor which only needs to handle a subset
 * of the available methods.
 */
class JsonPathBaseVisitor extends AbstractParseTreeVisitor implements JsonPathVisitor
{
	/**
	 * {@inheritdoc}
	 *
